...
//
//    private final String principleAtributte = "preferred_username";
//    @Override
...
//        if (principleAtributte != null){
//            claimName = principleAtributte;
//        }
...
//
//        if (resourceAccess.get("smen-rest-api") == null) return Set.of();
//
//        resource = (Map<String, Object>) resourceAccess.get("smen-rest-api");
